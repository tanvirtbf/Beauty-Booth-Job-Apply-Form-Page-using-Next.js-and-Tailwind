  ...
  return (
    <div className="text-black w-full sm:w-2/5 p-5 flex flex-col gap-4">
      ...
      <form className="flex flex-col gap-3">
        ...
        <div className="flex flex-col gap-2">
          <label htmlFor="experience" className="text-lg pr-3 font-normal">Do you have any experience related to this job?</label>
          <input id="experience" type="text" placeholder='Your Answer' required className='inputBorder' />
        </div>
        <div className="flex flex-col gap-2">
          <label htmlFor="salary" className="text-lg pr-3 font-normal">Expected Salary</label>
